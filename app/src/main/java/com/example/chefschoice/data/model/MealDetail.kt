...
data class MealDetail(
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        parcel.writeString(dateModified as String?)
        parcel.writeString(idMeal)
        parcel.writeString(strArea)
        parcel.writeString(strCategory)
        parcel.writeString(strCreativeCommonsConfirmed as String?)
        parcel.writeString(strDrinkAlternate as String?)
        parcel.writeString(strImageSource as String?)
        ...
        parcel.writeString(strTags as String?)
